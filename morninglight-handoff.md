...
- Term 2 (Connect B1 Upper Primary, Lessons 11–20): Week 1 (Lesson 11, "Let the exploring begin!" — Genesis 1–11) and Week 2 (Lesson 12, "Promises, promises, promises" — Genesis 12:1–9) built, in `data_term2.js` / `images_term2.js`. **Weeks 3–10 (Lessons 13–20) are the main outstanding gap in the app.** The recurring memory verse was Genesis 1:1 (CEV) for Week 1, switching to Numbers 23:19 (CEV) — "God is no mere human!..." — starting Week 2; per the manual, Lesson 13 ("Waiting," Genesis 15–18, 21) keeps the same Numbers 23:19 verse, so it's likely still running for at least Week 3. Week 2 ships with NO images — its lesson's PowerPoint contains only title/word cards, a cycle-diagram recap, and a maze puzzle, no comic-style panel art — and uses the new `roleplay` block type for the Lesson 12 script (Abraham, Sarah, Lot, God).
